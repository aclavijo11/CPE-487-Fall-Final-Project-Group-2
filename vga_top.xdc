...
set_property -dict { PACKAGE_PIN D7    IOSTANDARD LVCMOS33 } [get_ports { vga_green[3] }]; #IO_L1P_T0_AD4P_35 Sch=vga_g[3]
set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports { vga_green[4] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=vga_g[4]
set_property -dict { PACKAGE_PIN F7    IOSTANDARD LVCMOS33 } [get_ports { vga_green[5] }]; #IO_L2N_T0_AD12N_35 Sch=vga_g[5]
...
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { vga_blue[2] }]; #IO_L2P_T0_AD12P_35 Sch=vga_b[2]
set_property -dict { PACKAGE_PIN E8    IOSTANDARD LVCMOS33 } [get_ports { vga_blue[3] }]; #IO_L4N_T0_35 Sch=vga_b[3]
